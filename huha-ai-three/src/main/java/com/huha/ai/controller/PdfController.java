...
import com.huha.ai.repository.ChatHistoryRepository;
import com.huha.ai.repository.FileRepository;
import com.huha.ai.entity.vo.Result;
...
public class PdfController {
    ...
    public reactor.core.publisher.Flux<String> Chat(String prompt, String chatId) {
        //1.找到会话文件
